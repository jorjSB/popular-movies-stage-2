...
public class MovieContentProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        uriMatcher.addURI(CONTENT_AUTHORITY, PATH_MOVIES + "/#", MOVIE_WITH_ID);

        return uriMatcher;
    }

    // Implementation of insert to handle requests to insert a single new row of data
    @Override
    ...
    // Delete - to delete a single row of data
    @Override
